...
<div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-slate-900 text-white flex-shrink-0 fixed h-full transition-all duration-300 z-50">
        ...
        <nav class="mt-4 px-3 space-y-1">
            ...
            <a href="/cctv/admin/inventory.php" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-slate-800 transition <?php echo str_contains($_SERVER['PHP_SELF'], 'inventory.php') ? 'bg-slate-800 border-l-4 border-indigo-500' : ''; ?>">
